...
let sampleProducts: [Product] = [
    ...
    Product(name: "Burrito", price: 6500, category: "Food", description: "Soft tortilla filled with fresh ingredients, perfect for a quick meal.", imageName: "food_burrito"),
    ...
    // Drinks Category
    Product(name: "Herbal Tea", price: 2.99, category: "Drinks", description: "A soothing blend of herbs and natural ingredients.", imageName: "drinks_tea"),
